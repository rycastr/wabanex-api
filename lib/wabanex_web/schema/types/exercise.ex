defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  @desc "Logic exercise reprensentation"
  object :exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :youtube_video_url, non_null(:string), description: "Exercises video"
    field :protocol_description, non_null(:string), description: "Exercises protocol"
